...
<div>
        ...
        <div class="max-w-[1216px] mx-auto px-5 sm:px-8 py-10 lg:py-16">
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-[26px]">
                @foreach ($page->list('pillars') as $p)
                    <div class="bg-white border border-line px-6 pt-6 pb-7 lg:px-[30px] lg:pt-[30px] lg:pb-[34px]">
    ...
    <div class="bg-paper border-t border-line">
        <div class="max-w-[1216px] mx-auto px-5 sm:px-8 py-12 lg:py-[72px] grid lg:grid-cols-[1fr_1.6fr] gap-8 lg:gap-16">
