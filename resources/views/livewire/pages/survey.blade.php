...
<div>
    ...
    <div class="max-w-[1216px] mx-auto px-8 py-16 grid lg:grid-cols-[1.3fr_1fr] gap-14 items-start">
        <div class="bg-ink px-11 pt-11 pb-12">
            <div class="text-[13.5px] font-bold tracking-[2.2px] text-brand mb-[18px]">{{ $page->get('box_eyebrow') }}</div>
            <div class="text-[27px] font-bold text-white mb-3.5 tracking-[-0.3px] text-pretty">{{ $page->get('box_title') }}</div>
    ...
    @if ($page->get('footer_note'))
        <div class="bg-paper border-t border-line">
            <div class="max-w-[1216px] mx-auto px-8 py-11 flex justify-between items-center gap-6 flex-wrap">
