...
@endphp
<footer data-vt="footer" class="bg-ink text-on-ink relative overflow-hidden">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-5 sm:px-8 py-10 lg:py-14">
        <div class="flex justify-between items-start gap-15 flex-wrap">
            <div class="max-w-sm">
                <img src="{{ asset('assets/logo-white.png') }}" alt="{{ $orgName }}" width="1800" height="234"
                     loading="lazy" decoding="async" class="h-10 block mb-5 w-auto">
                <div class="text-sm leading-relaxed">{!! nl2br(e($global->get('footer_address'))) !!}</div>
            </div>

            <div class="flex gap-18 text-sm leading-loose">
                <div>
            ...
            <div class="max-w-sm flex-1 min-w-70">
        ...
        <div class="border-t border-ink-line mt-11 pt-5 text-sm flex justify-between flex-wrap gap-2.5">
